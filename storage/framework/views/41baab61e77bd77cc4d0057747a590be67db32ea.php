                ...
                <div class="card-body">
                    <form method="POST" action="/guides">
                        ...
                        <div class="form-group row">
                            ...
                            <?php echo e(__('First name')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="lastname" v
                                alue="<?php echo e(old('lastname')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="idnumber"
                            class="col-md-4 col-form-label text-md-right">
                            <?php echo e(__('ID/Passport number')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                name="idnumber" value="<?php echo e(old('idnumber')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                name="phonenumber" value="<?php echo e(old('phonenumber')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    name="country" value="<?php echo e(old('country')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group  row">
                                ...
                                class="col-md-4 col-form-label text-md-right">
                                <?php echo e(__('Postal code')); ?></label>

                                <div class="col-md-6">
                                    <input id="postalcode" type="text"
                                    class="form-control <?php $__errorArgs = ['postalcode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    name="postalcode" value="<?php echo e(old('postalcode')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\Leonard\OTGMS\resources\views/guides/create.blade.php ENDPATH**/ ?>